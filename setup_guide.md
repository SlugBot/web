...
# Twitch Setup
To get SlugBot in your twitch chat, use the command `!twitchlink` in any Discord server with SlugBot. You will then receive a direct message with instructions on how to complete the account link process.
