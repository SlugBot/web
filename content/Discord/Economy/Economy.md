...
#### CLONER
[[plant#/plant cloner|/plant cloner]]
...
#### HIJACKER
[[plant#/plant hijacker|/plant hijacker]]
...
* Defensive Stat: **SCANNER**
#### HONEYPOT
[[plant#/plant honeypot|/plant honeypot]]
...
* Defensive Stat: **SCANNER**
#### REDIRECT
[[plant#/plant redirect|/plant redirect]]
...
* Defensive Stat: **SCANNER**
#### TRACKER
[[plant#/plant tracker|/plant tracker]]
...
* Defensive Stat: **ENCRYPTION**
#### CORRUPTOR
[[plant#/plant corruptor|/plant corruptor]]
...
* Defensive Stat: **ENCRYPTION**
#### ROOTKIT
[[plant#/plant rootkit|/plant rootkit]]
...
* Defensive Stat: **ENCRYPTION**
#### LATCH
[[plant#/plant latch|/plant latch]]
A LATCH is used to move an existing process from one target to another that you may or may not have access to directly. The LATCH process will attach itself to the existing specified process and lie dormant until the target plants their next process - at which point the latch will attempt to transfer the attached process to the target's target.

The trigger process and the target's target can optionally be manually specified - So the LATCH will only trigger when the specified process type is planted on the specified target.
...
**FAST_TRACK** - Reduce the remaining plant duration on a process in progress.<br>
**DELAY** - Increase the remaining plant duration on a process in progresss.<br>
**SCAN** - Scan properties of the process.<br>
**UNSCAN** - Hide a property of the process from anyone who may have scanned it.
